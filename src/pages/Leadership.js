  ...
  return (
    <div className="case-studies-container">
      <header className="container cases-container-header">
        <h4 className="title-label">Leadership</h4>
        <h2 className="home-subtitle">
          <strong>A LOOK INTO MY CREATIVE SIDE</strong>
          and my tendencies to lead.
        </h2>
        <div className="design-description">
          <img
            className="design-workshop-image"
            src={designWorkshops}
            alt="checkbox"
          />
          <p>
      ...
      <div className="case-studies">
        <section className="container cases-header">
          <div className="design-content">
            <h4 className="title-label design-title">Design Presentations</h4>
            <p>
          ...
          <div className="design-content">
            <h4 className="title-label design-title">
              ...
              <ul>
                ...
                <li>
                  <a href="https://docs.google.com/presentation/d/1z03_75qUzuR-ZwpMlvDWqyqH50sFd27VZU7cISolswU/edit?usp=sharing">
                    Make your own Typograhy - Presentation
                  </a>
                  <p>
          ...
          <div className="design-content">
            <h4 className="title-label design-title">Short Articles</h4>
            <div className="design-hackathons">
              <ul>
                <li>
